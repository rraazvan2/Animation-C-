    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cube = new VBO<Vector3>(new Vector3[] {
                new Vector3(1, 1, -1), new Vector3(-1, 1, -1), new Vector3(-1, 1, 2), new Vector3(1, 1, 2),         // top
                new Vector3(1, -1, 2), new Vector3(-1, -1, 2), new Vector3(-1, -1, -1), new Vector3(1, -1, -1),     // bottom
                new Vector3(1, 1, 2), new Vector3(-1, 1, 2), new Vector3(-1, -1, 2), new Vector3(1, -1, 2),         // front face
                new Vector3(1, -1, -1), new Vector3(-1, -1, -1), new Vector3(-1, 1, -1), new Vector3(1, 1, -1),     // back face
                new Vector3(-1, 1, 2), new Vector3(-1, 1, -1), new Vector3(-1, -1, -1), new Vector3(-1, -1, 2),     // left
                new Vector3(1, 1, -1), new Vector3(1, 1, 2), new Vector3(1, -1, 2), new Vector3(1, -1, -1) });      // right
